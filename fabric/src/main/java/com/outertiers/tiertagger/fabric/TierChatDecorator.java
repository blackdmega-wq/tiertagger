...
public final class TierChatDecorator {
     ...
     */
    private static Text decorate(Text message) {
        try {
            ...
            MutableText wrapped = BadgeRenderer.wrapNametag(cfg, opt.get(), Text.literal(""));
            ...
            return Text.empty().append(wrapped).append(Text.literal(" ")).append(message);
        } catch (Throwable t) {
            return message;
        }
    }
