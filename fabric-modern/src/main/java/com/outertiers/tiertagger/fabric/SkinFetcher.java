...
public final class SkinFetcher {
    ...
    public static final class Skin {
        ...
        Skin(ResourceLocation id, int width, int height) {
    ...
    static {
        ...
        try { tmp = ResourceLocation.fromNamespaceAndPath("tiertagger", "skins/__failed__"); }
        catch (Throwable t) { tmp = ResourceLocation.ofVanilla("textures/entity/player/wide/steve.png"); }
     ...
     */
    public static Optional<ResourceLocation> headFor(String name) {
            ...
            try {
                ...
                mc.execute(() -> {
                    try {
                        ...
                        DynamicTexture tex = com.outertiers.tiertagger.fabric.compat.Compat
                        ...
                        ResourceLocation id = ResourceLocation.fromNamespaceAndPath("tiertagger", "skins/" + safeId(key));
    ...
    /** ResourceLocation paths only allow a-z0-9/_.-; sanitise just in case. */
