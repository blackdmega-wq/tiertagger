...
public final class BadgeRenderer {
     ...
     */
    private static final ResourceLocation ICON_FONT_OUTERTIERS =
        ResourceLocation.fromNamespaceAndPath(ModeGlyphs.FONT_NAMESPACE, ModeGlyphs.FONT_PATH_OUTERTIERS);
    ...
    private static final class ModernFontSourceHolder {
        ...
        static final net.minecraft.network.chat.contents.StyleSpriteSource SOURCE_OT =
                new net.minecraft.network.chat.contents.StyleSpriteSource.Font(ICON_FONT_OUTERTIERS);
    ...
    private static Style applyIconFont(Style base, TierService svc) {
        ...
        ResourceLocation fontId = outerTiers ? ICON_FONT_OUTERTIERS : ICON_FONT;
     ...
     */
    private static MutableComponent glyph(TierService svc, String mode) {
    ...
    public static MutableComponent formatBadge(TierService svc, String tier, String mode,
        ...
        MutableComponent icon = glyph(svc, mode);
